...
The landscape-service acts as a database service and stores the runtime and evolution data generated by the [trace-service](https://git.se.informatik.uni-kiel.de/ExplorViz/code/trace-service) and the [code-analyzer](https://git.se.informatik.uni-kiel.de/ExplorViz/code/code-analyzer).
...
The landscape-service communicates with the [code-analyzer](https://git.se.informatik.uni-kiel.de/ExplorViz/code/code-analyzer) via gRPC and with the [trace-service](https://git.se.informatik.uni-kiel.de/ExplorViz/code/trace-service) via Apache Kafka. It provides a REST-API for the [frontend](https://git.se.informatik.uni-kiel.de/ExplorViz/code/frontend).
