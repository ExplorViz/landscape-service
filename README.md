...
The landscape-service acts as a database service and stores the runtime and evolution data generated by the [span-service](https://git.se.informatik.uni-kiel.de/ExplorViz/code/span-service) and the [code-agent](https://git.se.informatik.uni-kiel.de/ExplorViz/code/code-agent).
