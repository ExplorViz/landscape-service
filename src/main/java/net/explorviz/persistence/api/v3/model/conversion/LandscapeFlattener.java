...
public final class LandscapeFlattener {
  ...
  private record Context(
      ...
      Set<ChimneyPlatformDto> chimneyPlatforms,
  ...
  public static FlatLandscapeDto flattenLandscape(
    ...
    final Map<String, ChimneyPlatformDto> chimneyPlatforms =
        resultContainer.chimneyPlatforms.stream()
            .collect(
                Collectors.toMap(
                    cp -> cp.flatBaseModel().id(), Function.identity(), (cp1, cp2) -> cp1));
    ...
    final CityDto city =
        new CityDto(
            new FlatBaseModel(
                ...
                cityConvertible.getDebugSnapshotComparison()),
            ...
            context.chimneyPlatforms.stream().map(cp -> cp.flatBaseModel().id()).toList(),
    ...
    final DistrictDto district =
        new DistrictDto(
            new FlatBaseModel(
                ...
                districtConvertible.getDebugSnapshotComparison()),
    ...
    final BuildingDto building =
        new BuildingDto(
            new FlatBaseModel(
                ...
                buildingConvertible.getDebugSnapshotComparison()),
            context.parentCityId,
            context.parentDistrictId,
            buildingConvertible.getLanguage(),
            buildingConvertible.getMetrics(),
            buildingConvertible.getChimneyPlatforms());
