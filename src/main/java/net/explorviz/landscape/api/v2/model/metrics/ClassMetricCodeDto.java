...
public record ClassMetricCodeDto(
    String loc, String LCOM4, String cyclomatic_complexity_weighted, String cyclomatic_complexity) {
  private static final String FALLBACK = "UNKNOWN";

  public ClassMetricCodeDto(final Clazz ogmClazz) {
    this(
        Objects.toString(ogmClazz.getMetrics().get("loc"), FALLBACK),
