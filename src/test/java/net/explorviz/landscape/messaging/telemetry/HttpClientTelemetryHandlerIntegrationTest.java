...
@QuarkusTest
public class HttpClientTelemetryHandlerIntegrationTest {
  ...
  void testSaveEntity() {
    HttpClientDescriptor descriptor =
        HttpClientDescriptor.newBuilder()
    ...
    TelemetryEntity entity =
        TelemetryEntity.newBuilder()
            ...
            .setHttpClientDescriptor(descriptor)
            .build();
    ...
    System.out.println(expectedLandscape);
